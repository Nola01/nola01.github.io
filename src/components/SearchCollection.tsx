    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
      ...
      <div class="col-span-3 sm:col-span-1">
        <div class="sticky top-24 mt-7">
          {/* Search Bar */}
          <SearchBar onSearchInput={onSearchInput} query={query} setQuery={setQuery} placeholderText={`Buscar proyectos`} />
          {/* Tag Filters */}
        ...
        <div class="flex flex-col">
          ...
          <div class='flex justify-between flex-row mb-2'>
            <div class="text-sm uppercase">
              MOSTRANDO {collection().length} DE {data.length} PROYECTOS
            </div>
